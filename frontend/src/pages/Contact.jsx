...
export default function Contact() {
  useSEO({
    title: "Contact",
    description:
      "Contact Lotus USA Inc. — request a consultation for government contracting, staffing, CMMC compliance, or digital solutions.",
    path: "/contact",
  });
  ...
  const inputCls =
    "w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-navy outline-none transition-colors placeholder:text-slate-400 focus:border-royal";
            ...
            <Reveal>
              ...
              >
                ...
                <p
                  ...
                  data-testid="contact-privacy-notice"
                >
                  By submitting this form, you acknowledge that Lotus USA,
                  Inc. will use the information provided to respond to your
                  request. See our{" "}
                  <Link
                    to="/privacy-policy"
                    className="font-medium text-royal underline hover:text-navy"
                  >
                    Privacy Policy
                  </Link>{" "}
          ...
          <div className="lg:col-span-5">
            <Reveal delay={0.1}>
              ...
              <div className="rounded-3xl bg-navy p-8 text-white lg:p-10">
                ...
                <ul className="mt-7 space-y-5 text-sm">
                  ...
                  <li className="flex gap-4">
                    <MapPin className="h-5 w-5 shrink-0 text-royal-light" />
                  ...
                  <li className="flex gap-4">
                    <Phone className="h-5 w-5 shrink-0 text-royal-light" />
                  ...
                  <li className="flex gap-4">
                    <Mail className="h-5 w-5 shrink-0 text-royal-light" />
                  ...
                  <li className="flex gap-4">
                    <Clock className="h-5 w-5 shrink-0 text-royal-light" />

                    <span>
                      Mon–Fri · 7:00 AM ET – 7:00 PM ET
                    </span>
                  </li>
                  ...
                  <li className="flex gap-4">
                    <Linkedin className="h-5 w-5 shrink-0 text-royal-light" />
              ...
              <div className="mt-6 overflow-hidden rounded-3xl border border-slate-200">
                ...
                {functional ? (
                  <iframe
                    title="Lotus USA Inc. location"
                    width="100%"
                    height="280"
                    loading="lazy"
                    style={{ border: 0 }}
                    src="https://www.google.com/maps?q=355+S+Grand+Ave+Suite+2450+Los+Angeles+CA+90071&output=embed"
                    data-testid="contact-map"
                  />
                ) : (
                  <div
                    className="flex h-[280px] flex-col items-center justify-center gap-3 bg-slate-50 px-6 text-center"
                  ...
                  >
                    ...
                    <p className="max-w-xs text-xs text-slate-500">
                      The interactive map uses Google Maps (a functional
                      cookie). Enable functional cookies to load it.
                    </p>

                    <button
                      type="button"
                      onClick={openPreferences}
                      className="rounded-full bg-navy px-5 py-2.5 text-xs font-semibold text-white transition-colors hover:bg-royal"
                      data-testid="contact-map-enable"
                    >
                      Enable map
                    </button>
                  </div>
              ...
              >
                ...
                <a
                  href={pdf}
                  download
                  className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-full bg-navy px-6 py-3 text-sm font-semibold text-white transition-colors duration-300 hover:bg-royal"
                  data-testid="download-capability-contact"
                >
